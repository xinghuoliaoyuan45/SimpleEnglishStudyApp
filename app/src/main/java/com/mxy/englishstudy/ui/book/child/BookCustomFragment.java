...
import com.mxy.englishstudy.adapter.BookAdapter;
import com.mxy.englishstudy.base.BaseFragment;
import com.mxy.englishstudy.bean.book.BookBean;
import com.mxy.englishstudy.databinding.FragmentBookCustomBinding;
        ...
        bindingView.xrvBook.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    ...
                    Log.e("mLayoutManager",mLayoutManager.getItemCount()+"  getItemCount");
                    Log.e("mLayoutManager",mLayoutManager.findFirstVisibleItemPosition()+"  findFirstVisibleItemPosition");
                    Log.e("mLayoutManager",mLayoutManager.findLastVisibleItemPosition()+"  findLastVisibleItemPosition");
